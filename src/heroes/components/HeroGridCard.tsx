    ...
    >
      <div className="relative h-64">
        ...
        <div className="absolute top-3 left-3 flex items-center gap-2">
          <div
            className={`w-3 h-3 rounded-full ${hero.status === "Active" ? "bg-green-500" : "bg-gray-500"}`}
          />
          <Badge
            variant="secondary"
        ...
        {/* Universe badge */}
        <Badge
          className={`absolute top-3 text-white right-3 text-xs ${hero.universe === "DC" ? "bg-blue-600 " : "bg-red-600"}`}
        >
          {hero.universe}
        </Badge>
        ...
        >
          <Heart
            className={`h-4 w-4
            ${isFavorite(hero) ? "fill-red-500 text-red-500" : ""}
            `}
          />
        </Button>
      ...
      <CardHeader className="py-6 z-10 bg-gray-100/50 backdrop-blur-sm relative top-1 group-hover:top-2.5 transition-all duration-300">

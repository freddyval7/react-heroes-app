...
export const HeroPage = () => {
  ...
  const { data: heroData, isError } = useHero(idSlug);
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="flex-1 text-center md:text-left">
              <div className="flex flex-wrap gap-2 justify-center md:justify-start mb-4">
                <Badge
                  className={`${getCategoryColor(heroData.category)} text-white`}
                >
                  {heroData.category}
                </Badge>
                <Badge
                  className={`${getStatusColor(heroData.status)} text-white`}
                >
                  {heroData.status}
                </Badge>
                <Badge
              ...
              <p className="text-xl text-blue-200 mb-4">{heroData.name}</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <Card className="text-center">
                <CardContent className="pt-6">
                  ...
                  <Progress
                    value={heroData.intelligence * 10}
                    className="h-2"
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div className="flex justify-between items-center py-2 border-b">
                    ...
                    <span className="font-semibold">{heroData.name}</span>
                  </div>
                  <div className="flex justify-between items-center py-2 border-b">
                    <span className="text-gray-600">Alias:</span>
                    <span className="font-semibold">{heroData.alias}</span>
                  </div>
                  <div className="flex justify-between items-center py-2 border-b">
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div className="flex justify-between items-center py-2 border-b">
                    ...
                    <span className="font-semibold">{heroData.universe}</span>
                  </div>
                  <div className="flex justify-between items-center py-2 border-b">
                  ...
                  <div className="flex justify-between items-center py-2">
                    ...
                    <span className="font-semibold">
                      {new Date().getFullYear() -
                        Number.parseInt(heroData.firstAppearance)}{" "}
                      años
                    </span>
                  </div>
                </CardContent>
